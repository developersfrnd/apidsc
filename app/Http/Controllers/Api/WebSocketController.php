...
class WebSocketController extends APIController implements MessageComponentInterface{
    private $connections = [];
    ...
    function onOpen(ConnectionInterface $conn){
        ...
        return $this->sendResponse(json_encode(['connected']), trans('responses.msgs.success'), config('constant.header_code.ok'));
    }
